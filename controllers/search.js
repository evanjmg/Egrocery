...
var TescoProductSearch = function (query, callback) {
  ...
  request('https://secure.techfortesco.com/tescolabsapi/restservice.aspx?command=LOGIN&email=&password=&developerkey='+ process.env.TESCO_API_ACCOUNT_KEY+ '&applicationkey='+ process.env.TESCO_API_APP_KEY, function (err, resp, b) {
